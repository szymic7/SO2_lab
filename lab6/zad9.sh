...
grep '^#' "$0" | sed --regexp-extended 's/ ([a-zA-Z]) / \1\&nbsp;/g'

# 's/ ([a-zA-Z]) / \1\&nbsp;/g' => szukamy pojedynczej litery, otoczonej spacjami
# zastepujemy ' a ' => ' a&nbsp;' (\1 => referencja do 1. grupy dopasowania = litery)
